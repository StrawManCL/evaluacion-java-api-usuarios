package cl.banco.evaluacion.config;
...
public class JwtAuthFilter extends OncePerRequestFilter {
   ...
   * con el prefijo esperado ({@code "Bearer "}), y en caso afirmativo, intenta extraer el name de
  ...
  protected void doFilterInternal(HttpServletRequest request, @NonNull HttpServletResponse response,
    ...
    try {
      ...
      response.getWriter()
          .write("{\"mensaje\": \"Token inválido: " + e.getMessage() + "\"}");
    }
